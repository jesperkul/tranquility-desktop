...
export const AppContextProvider: React.FC<WindowListProviderProps> = ({
	children
}) => {
	const AppButtons = [
		{
		...
		},
		{
			...
			name: 'Chip Player JS',
			component: (
				<Framed src="https://mmontag.github.io/chip-player-js/browse/ModArchives" />
			),
		...
		},
		{
			id: 7,
			name: 'Essence Reader',
			component: <Framed src="https://jesperkul.github.io/essence-reader" />,
